...
namespace lst\LaravelQueueRocketMQ\Horizon;
...
use lst\LaravelQueueRocketMQ\Queue\RocketMQQueue as BaseRocketMQQueue;

class RocketMQQueue extends BaseRocketMQQueue
{
    /**
    ...
    public function pop($queueName = null)
    {
        return tap(parent::pop($queueName), function ($result) use ($queueName) {
            if ($result instanceof RocketMQJob) {
